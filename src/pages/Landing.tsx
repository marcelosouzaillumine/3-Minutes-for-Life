...
export function Landing() {
  ...
  const sustainabilityItems = t(
    'landing:sustainability.items',
    {
      returnObjects: true,
    }
  ) as Array<{
  ...
  return (
    <div className="landing-page">
              ...
              devotional={
                {
                  ...
                  reflection:
                    demoPrinciple.principle +
                    '\n\n' +
                    demoPrinciple.reflection,
                  practical_application:
                    demoPrinciple.application,
                  categories: {
                    name: demoPrinciple.category,
                  },
                  status: 'published',
      ...
      <section className="quote-section" ref={setRef}>
        ...
        <div
          className="perceived-statement reveal delay-100"
          style={{ margin: 0 }}
        >
          <span
            dangerouslySetInnerHTML={{
