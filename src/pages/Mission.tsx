  ...
  return (
    <div className="mission-page">
      ...
      <section className="mission-hero">
        ...
        <div
          className="mission-hero-text reveal"
          ref={setRef}
        >
        ...
        <div
          className="mission-hero-visual reveal delay-200"
          ref={setRef}
        />
      ...
      <section className="mission-parallax-section">
        ...
        <div className="parallax-content">
          ...
          <div
            className="parallax-conclusion reveal delay-500"
            ref={setRef}
          >
            <h3>
              {t('parallax.conclusion')
                .split('\n')
                .map(
                  (
                    line: string,
      ...
      <section className="mission-minimal-section">
        ...
        <div
          className="minimal-conclusion reveal delay-500"
          ref={setRef}
        >
          <p>
            {t('minimal.conclusion1')}
          </p>

          <p className="highlight">
            {t('minimal.conclusion2')}
          </p>
        </div>
      ...
      <section className="mission-monumental-section">
        ...
        <p className="monumental-subtitle">
          {t('monumental.subtitle')}
        </p>

        <div className="monumental-text-block">

          <p className="monumental-intro">
            {t('monumental.intro')}
          </p>

          <p className="monumental-core">
            {t('monumental.core')}
          </p>
      ...
      <section className="mission-editorial-pricing">
        ...
        <div
          className="editorial-tiers simplified-tiers reveal delay-100"
          ref={setRef}
        >
          ...
          <div className="editorial-tier">
            ...
            <div className="editorial-tier-price">
              ...
              <span className="editorial-price-main">
                ...
                <small>
                  {t('editorial.monthlyPriceUnit')}
                </small>
              </span>

              <span className="editorial-price-sub">
                {t('editorial.monthlyDesc')}
              </span>
          ...
          <div className="editorial-tier highlight-tier">
            ...
            <div className="editorial-tier-badge">
              {t('editorial.yearlyBadge')}
            </div>

            <h3 className="editorial-tier-name">
              {t('editorial.yearlyTitle')}
            </h3>
            ...
            <div className="editorial-tier-price">
              ...
              <span className="editorial-price-main">
                ...
                <small>
                  {t('editorial.yearlyPriceUnit')}
                </small>
              </span>

              <span className="editorial-price-sub">
                {t('editorial.yearlyDesc')}
              </span>
        ...
        <div
          className="editorial-free reveal delay-200"
          ref={setRef}
        >

          <h3>
            {t('editorial.freeTitle')}
          </h3>

          <p>
            {t('editorial.freeDesc')}
          </p>
      ...
      <section className="mission-closing-section">
        ...
        <div
          className="closing-final reveal delay-400"
          ref={setRef}
        >
