  ...
  return (
    <nav className="bottom-nav">
      ...
      <a 
        ...
        className={`nav-item ${pathname.includes('/translations') ? 'active' : ''}`}
        style={{ textDecoration: 'none' }}
      >
        <svg className="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <a 
        ...
        className={`nav-item ${pathname.includes('/relationship') || pathname.includes('/testimonials') ? 'active' : ''}`}
        style={{ textDecoration: 'none' }}
      >
        <svg className="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <a 
        href="/admin/identity"
        className={`nav-item ${pathname.includes('/identity') ? 'active' : ''}`}
        style={{ textDecoration: 'none' }}
      >
        <svg className="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
